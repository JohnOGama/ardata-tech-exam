...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface OgamaTokenInterface extends Interface {
    getFunction(nameOrSignature: "allowance" | "allowance(address,address)" | "approve" | "approve(address,uint256)" | "balanceOf" | "balanceOf(address)" | "decimals" | "decimals()" | "mint" | "mint(address,uint256)" | "name" | "name()" | "symbol" | "symbol()" | "totalSupply" | "totalSupply()" | "transfer" | "transfer(address,uint256)" | "transferFrom" | "transferFrom(address,address,uint256)"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "Approval(address,address,uint256)" | "Transfer" | "Transfer(address,address,uint256)"): EventFragment;
